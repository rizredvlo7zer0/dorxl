  ...
  if(isset($_POST['button']))
   {
    ...
    if($idpaket==null)
      ...
      { 
         ...
         $ubuy='https://my.xl.co.id/pre/opPurchase';
         $dbuy=[
              ...
              <form class="user"method="post"action="">
               ...
               <div class="col-sm-6 mb-3 mb-sm-0">
                 <select name="paket" class="custom-select custom-select-lg mb-3">
                   <option disabled>Paket Umum</option>
                  ...
                  <!-- <option value="2"<?php if(isset($_POST["button"])){if($select==2){echo"selected";};};?>>MAXstream 7GB ,7k,3hr</option>
                   <option disabled>Kuota flash + aplikasi</option>-->
                    <option disabled>Paket Inject</option>
                   </select>
                </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="idpaket" placeholder="pkgid">
                  </div>
                 </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="submit" class="btn btn-primary btn-user btn-block" name="button"value="beli">
                  </div>
                </div>
                <br><br>
                <div class="form-group row">
